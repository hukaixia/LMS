...
<br><br><li class="col-ld-1 glyphicon glyphicon-heart-empty">新书上架</li><br><br>
<form class="form-horizontal"  action="${pageContext.request.contextPath}/admin/addBook" method="post"  enctype="multipart/form-data">
	<div class="row col-md-3 col-md-offset-2">
	  <div class="form-group">
	    <label >书 名</label>
	    <input type="text" class="form-control" name="bookName" id="bNameChange" placeholder="书名">
	    <span class="bookName"></span>
	  </div>
	  <div class="form-group">
	    <label>图书简介</label>
	    <input type="text" class="form-control" name="bookIntro" id="bIntroChange" placeholder="主题词">
	    <span class="bookIntro"></span>
	  </div>
	  <div class="form-group">
	    <label>作者:多个作者请用/分开</label>
	    <input type="text" class="form-control" name="writer" id="wChange" placeholder="作者">
	    <span class="writer"></span>
	  </div>
	  <div class="form-group">
	    <label >价格</label>
	    <input type="text" class="form-control" name="bookPrice" id="bPriceChange" placeholder="价格">
	    <span class="bookPrice"></span>
	  </div>
	  <div class="form-group">
	    <label >图片</label>
	    <input type="file" class="form-control" id="bImageChange" name="bookImage" placeholder="图片">
	    <span class="bookImage"></span>
	  </div>
	  <div class="form-group">
	    <label >可供借出数</label>
	    <input type="number" class="form-control" min="0" id="aLoanChange" name="avaliableLoan" placeholder="可供借出数">
	...
	<div class="row col-md-3 col-md-offset-1">
	  <div class="form-group">
	    <label >索书号</label>
	    <input type="text" class="form-control" name="bookCallno" id="bCallnoChange" placeholder="索书号,长度为4-10">
	    <span class="bookCallno"></span>
	  </div>
	  <div class="form-group">
	    <label >ISBN号</label>
	    <input type="text" class="form-control" name="ISBN" id="isbnchange" placeholder="ISBN 长度为 8-18">
	    <span class="ISBN"></span>
	  </div>
	  <div class="form-group">
	    <label >字数</label>
	    <input type="number" class="form-control" min="1000" name="wordNumber" id="wNumberChange" placeholder="字数">
	     <span class="wordNumber"></span>
	  </div>
	  <div class="form-group">
	    <label >出版时间</label>
	    <input type="date" class="form-control" name="publishDate" id="pDataChange" placeholder="出版时间">
	    <span class="publishDate"></span>
	  </div>
	  <div class="form-group">
	    <label >馆藏时间</label>
	    <input type="date" class="form-control"  name="collectionDate" id="cDateChange" placeholder="馆藏时间">
	    <span class="collectionDate"></span>
	  </div>
	  <div class="form-group">
	    <label >馆藏数</label>
	    <input type="number" class="form-control" min="1" name="collectionNumber" id="cNumberChange" placeholder="馆藏数">
	...
	<div style="padding-top:650px;padding-left:420px" >
     <br><br>
     <button type="submit" id="submitMess" class="btn btn-info btn-lg">添加</button> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
